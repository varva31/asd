...
<head>
    ...
    <script type="text/javascript" class="silex-json-styles">
        [{"desktop":{"body-initial":{"background-color":"rgba(255,255,255,1)"},"silex-id-1474394621033-3":{"top":"5px","left":"0px","background-color":"rgba(0,0,0,1)"},"silex-id-1474394621032-2":{"min-height":"600px","background-color":"transparent","width":"1200px"},"silex-id-1474394605264-1":{"min-height":"100px","width":"100px","top":"100px","left":"100px"},"silex-id-1474394605263-0":{"min-height":"100px","background-color":"transparent"},"silex-id-1442914737143-3":{"min-height":"53px","width":"349px","top":"29px","left":"430px"},"silex-id-1478366444112-0":{"min-height":"185px","background-color":"transparent","width":"1200px","top":"15px","left":"203px","background-image":"url('unnamed.png')","background-attachment":"fixed","background-repeat":"no-repeat","background-position":"top center"},"silex-id-1478366444112-1":{"top":"100px","left":"NaNpx","background-color":"rgba(0,0,0,1)","min-width":"1200px"},"silex-id-1478366450713-2":{"min-height":"100px","background-color":"transparent","width":"1200px"},"silex-id-1519347889643-0":{"width":"276px","min-height":"117px","top":"6px","left":"461px"},"silex-id-1519347978367-1":{"width":"400px","height":"400px","background-color":"transparent","top":"147px","left":"414px"}},"mobile":{},"componentData":{"silex-id-1519347978367-1":{"name":"form1","templateName":"form","submitButtonLabel":"Look for Love","buttonTextColor":"#ff80ff","buttonBackgroundColor":"#000000","placeholder1":"IGN","label2":"The class your looking for","placeholder2":"Ninja, Witch, Kuno etc.....","label3":"Bio","placeholder3":"Fill out some info about your self.","sendTo":"varvakid123@gmail.com"}}}]
    </script>
    ...
    <link href="http://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic" rel="stylesheet" type="text/css" class="silex-custom-font">
...
<body data-silex-id="body-initial" class="body-initial silex-runtime" data-silex-type="container">
    ...
    <div data-silex-type="container" class="prevent-draggable container-element editable-style silex-id-1474394621033-3 section-element" data-silex-id="silex-id-1474394621033-3" style="">
        <div data-silex-type="container" class="editable-style silex-element-content silex-id-1474394621032-2 silex-container-content container-element prevent-draggable website-width" data-silex-id="silex-id-1474394621032-2">
            <div data-silex-type="text" class="editable-style silex-id-1519347889643-0 text-element" data-silex-id="silex-id-1519347889643-0" style="">
                <div class="silex-element-content normal">
                    <div style="text-align: center;">
                        <font size="7" face="Roboto" color="#ff00ff">Relic Speed Dating</font>
                    </div>
                    <div style="text-align: center;">
                        <font face="Roboto" color="#ff00ff" size="2">(No Tamers!)</font>
                    </div>
                </div>
            </div>
            <div data-silex-type="html" class="editable-style silex-id-1519347978367-1 html-element silex-component silex-component-form silex-use-height-not-minheight" data-silex-id="silex-id-1519347978367-1" style="">
                <div class="silex-element-content">
                    <form id="id_1519348174619_772" action="https://formspree.io/varvakid123@gmail.com" method="POST">

                        <div>
                            <label for="field1">Name</label>
                            <input type="text" required="" id="field1" name="field1" placeholder="IGN">
                        </div>


                        <div>
                            <label for="field2">The class your looking for</label>
                            <input type="text" required="" id="field2" name="field2" placeholder="Ninja, Witch, Kuno etc.....">
                        </div>


                        <div class="fill-vertical">
                            <label for="field3">Bio</label>
                            <textarea required="" id="field3" name="field3" placeholder="Fill out some info about your self."></textarea>
                        </div>
    ...
    <input type="submit" value="Upload Image" name="submit">
                        <input type="submit" value="Look for Love">
                    </form>
                    <style>
                        #id_1519348174619_772 input[type=text],
                        select {
                            width: 100%;
                            padding: 12px 20px;
                            margin: 8px 0;
                        ...
                        #id_1519348174619_772 input[type=submit] {
                            width: 100%;
   ...
   and fill the vertical space */
                        ...
                        #id_1519348174619_772 .fill-vertical {
                            flex: 1 1 auto;
                            display: flex;
                            flex-direction: column;
                        }
                        
                        #id_1519348174619_772 .fill-vertical textarea {
                            flex: 1 1 auto;
                            width: 100%;
                            height: 150px;
                            padding: 12px 20px;
